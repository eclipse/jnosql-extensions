...
class ColumnRepositoryMetadata extends RepositoryMetadata {

    ColumnRepositoryMetadata(RepositoryElement element) {
        super(element);
    }

    @Override
    String getClassName() {
        return this.getElement().getSimpleName() + "LiteColumn";
    }
