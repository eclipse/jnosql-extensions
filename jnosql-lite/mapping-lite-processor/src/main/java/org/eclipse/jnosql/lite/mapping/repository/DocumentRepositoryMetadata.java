...
class DocumentRepositoryMetadata extends RepositoryMetadata {

    DocumentRepositoryMetadata(RepositoryElement element) {
        super(element);
    }

    @Override
    String getClassName() {
        return this.getElement().getSimpleName() + "LiteDocument";
    }
