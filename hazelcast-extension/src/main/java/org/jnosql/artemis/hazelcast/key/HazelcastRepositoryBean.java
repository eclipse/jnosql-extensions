...
class HazelcastRepositoryBean implements Bean<HazelcastRepository>, PassivationCapable {
    ...
    @Override
    public void destroy(HazelcastRepository instance, CreationalContext<HazelcastRepository> creationalContext) {
