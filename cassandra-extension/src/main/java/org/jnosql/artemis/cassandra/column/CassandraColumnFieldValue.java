...
/**
 * The Cassandra column implementation of {@link ColumnFieldValue}
 */
class CassandraColumnFieldValue implements ColumnFieldValue {

    private final FieldValue fieldValue;

    private CassandraColumnFieldValue(FieldValue fieldValue) {
    ...
    static CassandraColumnFieldValue of(Object value, FieldRepresentation field) {
        return new CassandraColumnFieldValue(FieldValue.of(value, field));
    }
